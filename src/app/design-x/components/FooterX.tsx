            ...
            <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-white/50">
                            {[
                                { label: t('General Construction'), href: '/design-x/services/general-construction' },
                                ...
                                <li key={i}>
                                    <Link href={item.href} className="flex items-center gap-2 hover:text-accent-orange transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-6 text-sm text-white/50">
                            <li className="flex gap-4">
                                ...
                                <a
                                    href="https://maps.google.com/?q=Monivong+Blvd,+Phnom+Penh"
                                    target="_blank"
                            ...
                            <li className="flex gap-4 items-center">
                                ...
                                <a href="tel:+85523999888" className="hover:text-accent-orange cursor-pointer transition-colors">+855 23 999 888</a>
                            </li>
                            <li className="flex gap-4 items-center">
                                <Mail size={20} className="text-accent-orange shrink-0" />
                                <a href="mailto:info@kimmex.com.kh" className="hover:text-accent-orange cursor-pointer transition-colors">info@kimmex.com.kh</a>
                            </li>
                        </ul>
                    </div>
                </div>
