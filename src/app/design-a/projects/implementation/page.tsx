...
// --- SHARED COMPONENTS (Simplified for brevity, reuse from previous files ideally) ---
// Note: In a real app, these would be imported from a shared component file to avoid duplication.
// I will include the minimal necessary parts here for the page to function self-contained or
// I can assume the user wants the full code. I'll include the full necessary code for the page.
