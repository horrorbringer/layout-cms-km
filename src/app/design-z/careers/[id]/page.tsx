...
export default function CareerDetailPage() {
    ...
    const job = allJobs.find(j => j.id === id) || allJobs[0];
                ...
                <div className="max-w-[1200px] w-full mx-auto relative z-10 px-6">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                            <div>
                                <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight text-white">{getLocalizedText(job.title, language)}</h1>
