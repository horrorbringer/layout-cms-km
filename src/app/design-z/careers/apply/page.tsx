                    ...
                    <form onSubmit={(e) => { e.preventDefault(); alert('Application Submitted (Mock)'); }}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-sm p-3 text-titan-navy focus:border-titan-red focus:outline-none transition-colors" placeholder={language === 'kh' ? 'ឧ. សុខ' : 'John'} required />
                            </div>
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-titan-navy mb-2">{t('Last Name')}</label>
                                <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-sm p-3 text-titan-navy focus:border-titan-red focus:outline-none transition-colors" placeholder={language === 'kh' ? 'ឧ. ដារ៉ា' : 'Doe'} required />
                            </div>
                        </div>
                        ...
                        <div className="mb-8">
                            ...
                            <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-sm p-3 text-titan-navy focus:border-titan-red focus:outline-none transition-colors" placeholder={language === 'kh' ? 'ឧ. គ្រប់គ្រងគម្រោង, វិស្វកម្ម...' : 'e.g. Project Management, Engineering...'} required />
                        </div>
