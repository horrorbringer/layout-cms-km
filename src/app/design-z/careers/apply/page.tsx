                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-sm p-3 text-titan-navy focus:border-titan-red focus:outline-none transition-colors" placeholder={t('First Name')} required />
                            </div>
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-titan-navy mb-2">{t('Last Name')} *</label>
                                <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-sm p-3 text-titan-navy focus:border-titan-red focus:outline-none transition-colors" placeholder={t('Last Name')} required />
                            </div>
                        </div>
                        ...
                        <div className="mb-8">
                            ...
                            <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-sm p-3 text-titan-navy focus:border-titan-red focus:outline-none transition-colors" placeholder={t('Select Department...')} required />
                        </div>
