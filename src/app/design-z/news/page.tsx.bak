        ...
        <div className="bg-white min-h-screen font-sans text-titan-navy">
            ...
            <section className="relative h-[70vh] bg-titan-navy flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-titan-navy to-transparent opacity-50"></div>
                </div>
                ...
                <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pt-20">
                    ...
                    >
                        ...
                        <Link href={`/design-z/news/${featuredNews.id}`} className="relative block bg-white/10 backdrop-blur-md border border-white/10 p-8 rounded-2xl hover:bg-white/15 transition-all group">
            ...
            <div className="max-w-[1400px] mx-auto px-6 -mt-24 relative z-20 pb-20">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="lg:w-[70%] space-y-12">
                        ...
                        >
                            <Link href={`/design-z/news/${featuredNews.id}`} className="group relative block rounded-2xl overflow-hidden shadow-xl aspect-[16/9] border border-gray-100">
                            ...
                            <AnimatePresence mode='wait'>
                                {filteredNews.map((news, index) => (
                                    <motion.div
                                        ...
                                        key={news.id}
                                    >
                                        <Link href={`/design-z/news/${news.id}`} className="group flex flex-col h-full bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                    ...
                    <div className="lg:w-[30%] space-y-8 lg:sticky lg:top-24 h-fit">
                        ...
                        <div className="bg-titan-navy p-6 rounded-xl shadow-xl text-white relative overflow-hidden group cursor-pointer hover:shadow-2xl transition-all">
                            <Link href="/design-z/careers" className="absolute inset-0 z-20"></Link>
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <Link href="/design-z/documents" className="text-[10px] font-bold text-titan-navy-subtle hover:text-titan-navy transition-colors flex items-center gap-1">
                            ...
                            <div className="space-y-3">
                                {recentDocs.map((doc, i) => (
                                    <Link href="/design-z/documents" key={i} className="block bg-white hover:shadow-md p-3 rounded-lg border border-gray-100 transition-all group">
