...
export const homeData: HomeData = {
    hero: {
        title: {
            en: "Building Excellence Since 1999",
    ...
    stats: [
        {
            label: { en: 'Safety First', kh: 'សុវត្ថិភាពជាចម្បង' },
            val: { en: 'Zero accident policy', kh: 'គោលនយោបាយគ្រោះថ្នាក់សូន្យ' },
            iconName: 'ShieldCheck'
        },
        {
            label: { en: 'ISO Certified', kh: 'វិញ្ញាបនបត្រ ISO' },
            val: { en: '9001:2015 standards', kh: 'ស្តង់ដារ ៩០០១:២០១៥' },
            iconName: 'Award'
        },
        {
            label: { en: 'On-Time Delivery', kh: 'ការប្រគល់ជូនទាន់ពេល' },
            val: { en: '98% completion rate', kh: 'អត្រាបញ្ចប់ ៩៨%' },
            iconName: 'Clock'
        },
        {
            label: { en: 'Quality Focus', kh: 'ផ្តោតលើគុណភាព' },
            val: { en: 'Exceeding expectations', kh: 'លើសពីការរំពឹងទុក' },
            iconName: 'Target'
        }
    ],
    process: [
        {
            id: '1',
            step: '01',
            title: { en: 'Consultation', kh: 'ការពិគ្រោះយោបល់' },
            desc: { en: 'Understanding your vision and project requirements.', kh: 'ការយល់ដឹងពីចក្ខុវិស័យ និងតម្រូវការគម្រោងរបស់អ្នក។' },
            iconName: 'Target'
        },
        {
            id: '2',
            step: '02',
            title: { en: 'Planning', kh: 'ការរៀបចំផែនការ' },
            desc: { en: 'Detailed blueprints and strategic project mapping.', kh: 'ប្លង់លម្អិត និងការរៀបចំផែនទីគម្រោងយុទ្ធសាស្ត្រ។' },
            iconName: 'PenTool'
        },
        {
            id: '3',
            ...
            desc: { en: 'Expert execution with high-quality standards.', kh: 'ការអនុវត្តដោយអ្នកជំនាញដែលមានស្តង់ដារគុណភាពខ្ពស់។' },
            iconName: 'Hammer'
        },
        {
            id: '4',
            step: '04',
            title: { en: 'Handover', kh: 'ការប្រគល់ជូន' },
            desc: { en: 'Final quality inspection and project completion.', kh: 'ការត្រួតពិនិត្យគុណភាពចុងក្រោយ និងការបញ្ចប់គម្រោង។' },
            iconName: 'Trophy'
        }
    ],
    testimonials: [
