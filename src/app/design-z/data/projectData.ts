export const projects = [
    ...
    {
        id: 'gdce',
        title: 'General Dept. of Customs and Excise (GDCE)',
        location: 'Phnom Penh',
        type: 'Government Office Building',
        status: 'Completed',
    ...
    {
        id: 'pnt-stadium',
        title: 'National Stadium Expansion',
        location: 'Phnom Penh',
        type: 'Public Service Building',
        status: 'Completed',
    ...
    {
        id: 'kt-wtp',
        title: 'Khleang Toeuk Water Treatment Plant',
        location: 'Phnom Penh',
    ...
    {
        id: 'pv-wtp',
        title: 'Phum Prek Water Treatment Plant',
        location: 'Kandal',
        type: 'Water Treatment Plant',
        status: 'Completed',
        image: '/images/projects/Thumbnail-2.jpg',
