...
export default function ServiceDetailView({ service, detailId }: { service: ServiceDetail; detailId: string }) {
    // Icon Mapping
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <FadeInWhenVisible>
                        <div className="mb-12">
                            ...
                            <div
                                className="text-lg md:text-xl text-titan-navy/60 leading-relaxed mb-10 prose prose-lg prose-slate max-w-none"
                                dangerouslySetInnerHTML={{ __html: getLocalizedText(service.description, language) }}
                            />
                        </div>
                        ...
                        <div className="bg-gray-50 p-8 rounded-2xl border-l-4 border-titan-red shadow-sm">
                            ...
                            <div
                                className="text-titan-navy/70 leading-relaxed prose prose-sm prose-slate max-w-none"
                                dangerouslySetInnerHTML={{ __html: getLocalizedText(service.targetAudience, language) }}
                            />
                        </div>
                    </FadeInWhenVisible>
